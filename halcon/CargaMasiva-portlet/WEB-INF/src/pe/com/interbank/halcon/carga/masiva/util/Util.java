...
public class Util {
	 ...
	 */
	public static void returnJson(Object o, ActionResponse resourceResponse) throws IOException {
				
		String gsonString = gson.toJson(o);
		HttpServletResponse re = PortalUtil.getHttpServletResponse(resourceResponse);
		re.setContentType(ContentTypes.APPLICATION_JSON);
