 ...
 * </ul>
 * 
 * The Class UltimaSimulacionEditController.
 *
...
@Controller
@RequestMapping("EDIT")
public class UltimaSimulacionEditController {

	/** The _log. */
	private static Log _log = LogFactoryUtil.getLog(UltimaSimulacionEditController.class);
