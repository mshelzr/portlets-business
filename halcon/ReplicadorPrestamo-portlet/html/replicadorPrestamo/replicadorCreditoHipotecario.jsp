...
<input type="hidden" value="hipotecario" id="frmtipo" name="frmtipo" />
<div id="contentfrm">
	<form id="frmdata" action="${actionURL }" method="post">
	    ...
	    <div id="contenidoIni">
		    <div id="content-medio" class="replicador-ubicacion">
		      ...
		      <div class="sol-formulario replicador-contenedor">
		      	<input type="hidden" id="tipoReplicador" value="1">
		        <div class="campos-oblig">
		          <label>Nro Crédito</label>
		          <input type="text" class="textform wt224 float-left isnumber" id="numCredito" name="numCredito" maxLength="8" onpaste="return false;" ondragstart="return false;" ondrop="return false;" ondragover="return false;"/>
		        </div>
		        <div class="form-error">Debes ingresar el Nro de Crédito</div>	        
		        <div class="campos-oblig">
		        ...
		        <div class="campos-oblig">
		          ...
		          <div id="cmbTipoCuota" class="dropdown wt190 float-left" onpaste="return false;" ondragstart="return false;" ondrop="return false;" ondragover="return false;">
		          </div>
		        </div>
		        <div class="form-error"></div>
		        <div class="campos-oblig">
		          <label> Plazo en Meses</label>
		          <input type="text" class="textform wd124p float-left" id="plazoMeses" name="plazoMeses" maxLength="3" onpaste="return false;" ondragstart="return false;" ondrop="return false;" ondragover="return false;"/>
		        </div>
		        <div class="form-error"></div>
		        <div class="campos-oblig">
		...
		<!--         <input type="submit" id="btnCreHipotecario" value="Enviar" title="Enviar"> -->
		        <div class="bluebtn-der">&nbsp;</div>
		        <div class="both">&nbsp;</div>
		      </div>
		      <div id="btnclear" class="bluebtn-cont7 float-left mg5">
		        <div class="bluebtn-izq">&nbsp;</div>
		        <div class="bluebtn-medio boton"><a title="Limpiar" target="_self" href="javascript:;" class="boton">Limpiar</a></div>
		        <div class="bluebtn-der">&nbsp;</div>
		        <div class="both">&nbsp;</div>
		      </div>
		      </div>
...
<input type="hidden" id="credHipo" value='<portlet:resourceURL id="credHipotecario"/>' />
...
<input type="hidden" id="nombreReplicador" value="Hipotecario">