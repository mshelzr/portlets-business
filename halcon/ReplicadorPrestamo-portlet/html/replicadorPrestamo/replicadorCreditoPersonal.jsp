...
<input type="hidden" value="personal" id="frmtipo" name="frmtipo" />
<div id="contentfrm">
	 ...
	 <div id="namediv">
	    <div id="content-medio" class="replicador-ubicacion"> 
	      ...
	      <div class="sol-formulario replicador-contenedor">
	      	<input type="hidden" id="tipoReplicador" value="3">
	        ...
	        <div class="campos-oblig">
	          ...
	          <input type="text" class="textform wt224 float-left" id="montoFinanciarp" name="montoFinanciarp"  maxLength="10" onpaste="return false;" ondragstart="return false;" ondrop="return false;" ondragover="return false;"/>       
	          
	        </div>
	        <div class="form-error"></div>
	        <div class="campos-oblig">
	          <label>Tasa de Interés (TEA)</label>
	          <input type="text" class="textform wd124p float-left" id="tasaInteresp" name="tasaInteresp" maxLength="5" onpaste="return false;" ondragstart="return false;" ondrop="return false;" ondragover="return false;"/>
	        ...
	        <div class="campos-oblig">
	          ...
	          <input type="text" class="textform wd124p float-left" id="plazoMesesp" name="plazoMesesp" maxLength="2" onpaste="return false;" ondragstart="return false;" ondrop="return false;" ondragover="return false;"/>
	        </div>
	        <div class="form-error"></div>
	        <div class="campos-oblig">
	          <label> Per&iacute;odo de Gracia</label>
	          <input type="text" class="textform wd124p float-left" id="periodoGraciap" name="periodoGraciap" maxLength="2" onpaste="return false;" ondragstart="return false;" ondrop="return false;" ondragover="return false;"/>
	        </div>
	        <div class="form-error"></div>
	        ...
	        <div class="campos-oblig">
	          ...
	          <input type="text" class="textform wt129 datepiker float-left nogeneric"  value="dd/mm/aaaa"  id="fechaDes" name="fechaDes" maxLength="7" />
	        </div>
	        <div class="form-error"></div>
	        <div class=" campos-oblig">
	        ...
	        <div class="form-error"></div>
	        <div class=" campos-oblig">
	          <label> Envío Físico por Informe de Pago</label>
	          <input type="radio" class="campRad" value="1" checked="checked" name="rdbsend" id="envioFisico">
	          <p class="texRad">Sí.</p>
	          <input type="radio" class="campRad" value="0" name="rdbsend" id="envioFisico">
	          <p class="texRad">No.</p>
	        </div>
	        <div class="both"></div>
	        <div class="form-error"></div>
...
<input type="hidden" id="credPersonal" value='<portlet:resourceURL id="credPersonal"/>' />
...
<input type="hidden" id="urlPDF" value='<portlet:resourceURL id="descargarPDF" />'  >
<input type="hidden" id="nombreReplicador" value="Personal">