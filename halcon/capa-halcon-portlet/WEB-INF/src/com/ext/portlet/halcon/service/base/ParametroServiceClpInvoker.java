 ...
 */
public class ParametroServiceClpInvoker {
	public ParametroServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName168.equals(name) &&
			...
			return ParametroServiceUtil.getBeanIdentifier();
		}

		if (_methodName169.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes169, parameterTypes)) {
			ParametroServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		}
