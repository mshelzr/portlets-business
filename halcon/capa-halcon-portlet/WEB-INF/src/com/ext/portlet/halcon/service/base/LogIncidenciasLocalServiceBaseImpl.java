...
/**
 * The base implementation of the log incidencias local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.LogIncidenciasLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LogIncidenciasLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LogIncidenciasLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.LogIncidenciasLocalServiceUtil} to access the log incidencias local service.
	 */
	...
	public LogIncidencias addLogIncidencias(LogIncidencias logIncidencias)
		throws SystemException {
		logIncidencias.setNew(true);

		return logIncidenciasPersistence.update(logIncidencias, false);
	}
	 ...
	 */
	public LogIncidencias createLogIncidencias(long idError) {
		return logIncidenciasPersistence.create(idError);
	}
	...
	public LogIncidencias deleteLogIncidencias(long idError)
		throws PortalException, SystemException {
		return logIncidenciasPersistence.remove(idError);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LogIncidencias deleteLogIncidencias(LogIncidencias logIncidencias)
		throws SystemException {
		return logIncidenciasPersistence.remove(logIncidencias);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(LogIncidencias.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return logIncidenciasPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return logIncidenciasPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public LogIncidencias fetchLogIncidencias(long idError)
		throws SystemException {
		return logIncidenciasPersistence.fetchByPrimaryKey(idError);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LogIncidencias getLogIncidencias(long idError)
		throws PortalException, SystemException {
		return logIncidenciasPersistence.findByPrimaryKey(idError);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return logIncidenciasPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<LogIncidencias> getLogIncidenciases(int start, int end)
		throws SystemException {
		return logIncidenciasPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLogIncidenciasesCount() throws SystemException {
		return logIncidenciasPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LogIncidencias updateLogIncidencias(LogIncidencias logIncidencias)
		throws SystemException {
		return updateLogIncidencias(logIncidencias, true);
	}
	...
	public LogIncidencias updateLogIncidencias(LogIncidencias logIncidencias,
		...
		return logIncidenciasPersistence.update(logIncidencias, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.LogIncidencias",
			logIncidenciasLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = logIncidenciasPersistence.getDataSource();
	...
	private LogIncidenciasLocalServiceClpInvoker _clpInvoker = new LogIncidenciasLocalServiceClpInvoker();
}