...
/**
 * The base implementation of the carga socio remesa local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.CargaSocioRemesaLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CargaSocioRemesaLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CargaSocioRemesaLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.CargaSocioRemesaLocalServiceUtil} to access the carga socio remesa local service.
	 */
	...
	public CargaSocioRemesa addCargaSocioRemesa(
		CargaSocioRemesa cargaSocioRemesa) throws SystemException {
		cargaSocioRemesa.setNew(true);

		return cargaSocioRemesaPersistence.update(cargaSocioRemesa, false);
	}
	 ...
	 */
	public CargaSocioRemesa createCargaSocioRemesa(long idSocioRemesa) {
		return cargaSocioRemesaPersistence.create(idSocioRemesa);
	}
	...
	public CargaSocioRemesa deleteCargaSocioRemesa(long idSocioRemesa)
		throws PortalException, SystemException {
		return cargaSocioRemesaPersistence.remove(idSocioRemesa);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CargaSocioRemesa deleteCargaSocioRemesa(
		CargaSocioRemesa cargaSocioRemesa) throws SystemException {
		return cargaSocioRemesaPersistence.remove(cargaSocioRemesa);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CargaSocioRemesa.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return cargaSocioRemesaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cargaSocioRemesaPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CargaSocioRemesa fetchCargaSocioRemesa(long idSocioRemesa)
		throws SystemException {
		return cargaSocioRemesaPersistence.fetchByPrimaryKey(idSocioRemesa);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CargaSocioRemesa getCargaSocioRemesa(long idSocioRemesa)
		throws PortalException, SystemException {
		return cargaSocioRemesaPersistence.findByPrimaryKey(idSocioRemesa);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cargaSocioRemesaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CargaSocioRemesa> getCargaSocioRemesas(int start, int end)
		throws SystemException {
		return cargaSocioRemesaPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCargaSocioRemesasCount() throws SystemException {
		return cargaSocioRemesaPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CargaSocioRemesa updateCargaSocioRemesa(
		CargaSocioRemesa cargaSocioRemesa) throws SystemException {
		return updateCargaSocioRemesa(cargaSocioRemesa, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public CargaSocioRemesa updateCargaSocioRemesa(
		CargaSocioRemesa cargaSocioRemesa, boolean merge)
		throws SystemException {
		cargaSocioRemesa.setNew(false);

		return cargaSocioRemesaPersistence.update(cargaSocioRemesa, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.CargaSocioRemesa",
			cargaSocioRemesaLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cargaSocioRemesaPersistence.getDataSource();
	...
	private CargaSocioRemesaLocalServiceClpInvoker _clpInvoker = new CargaSocioRemesaLocalServiceClpInvoker();
}