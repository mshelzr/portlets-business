...
/**
 * The base implementation of the categoria subcategoria local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.CategoriaSubcategoriaLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CategoriaSubcategoriaLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CategoriaSubcategoriaLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.CategoriaSubcategoriaLocalServiceUtil} to access the categoria subcategoria local service.
	 */
	...
	public CategoriaSubcategoria addCategoriaSubcategoria(
		CategoriaSubcategoria categoriaSubcategoria) throws SystemException {
		categoriaSubcategoria.setNew(true);

		return categoriaSubcategoriaPersistence.update(categoriaSubcategoria,
			false);
	}
	 ...
	 */
	public CategoriaSubcategoria createCategoriaSubcategoria(
		long idCategoriaSubCat) {
		return categoriaSubcategoriaPersistence.create(idCategoriaSubCat);
	}
	...
	public CategoriaSubcategoria deleteCategoriaSubcategoria(
		long idCategoriaSubCat) throws PortalException, SystemException {
		return categoriaSubcategoriaPersistence.remove(idCategoriaSubCat);
	}
	...
	public CategoriaSubcategoria deleteCategoriaSubcategoria(
		CategoriaSubcategoria categoriaSubcategoria) throws SystemException {
		return categoriaSubcategoriaPersistence.remove(categoriaSubcategoria);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CategoriaSubcategoria.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return categoriaSubcategoriaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return categoriaSubcategoriaPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CategoriaSubcategoria fetchCategoriaSubcategoria(
		long idCategoriaSubCat) throws SystemException {
		return categoriaSubcategoriaPersistence.fetchByPrimaryKey(idCategoriaSubCat);
	}
	...
	public CategoriaSubcategoria getCategoriaSubcategoria(
		long idCategoriaSubCat) throws PortalException, SystemException {
		return categoriaSubcategoriaPersistence.findByPrimaryKey(idCategoriaSubCat);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return categoriaSubcategoriaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CategoriaSubcategoria> getCategoriaSubcategorias(int start,
		int end) throws SystemException {
		return categoriaSubcategoriaPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCategoriaSubcategoriasCount() throws SystemException {
		return categoriaSubcategoriaPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CategoriaSubcategoria updateCategoriaSubcategoria(
		CategoriaSubcategoria categoriaSubcategoria) throws SystemException {
		return updateCategoriaSubcategoria(categoriaSubcategoria, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.CategoriaSubcategoria",
			categoriaSubcategoriaLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = categoriaSubcategoriaPersistence.getDataSource();
	...
	private CategoriaSubcategoriaLocalServiceClpInvoker _clpInvoker = new CategoriaSubcategoriaLocalServiceClpInvoker();
}