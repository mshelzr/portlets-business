...
/**
 * The base implementation of the ocurrencia local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.OcurrenciaLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class OcurrenciaLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OcurrenciaLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.OcurrenciaLocalServiceUtil} to access the ocurrencia local service.
	 */
	...
	public Ocurrencia addOcurrencia(Ocurrencia ocurrencia)
		throws SystemException {
		ocurrencia.setNew(true);

		return ocurrenciaPersistence.update(ocurrencia, false);
	}
	 ...
	 */
	public Ocurrencia createOcurrencia(long idGestionPeticion) {
		return ocurrenciaPersistence.create(idGestionPeticion);
	}
	...
	public Ocurrencia deleteOcurrencia(long idGestionPeticion)
		throws PortalException, SystemException {
		return ocurrenciaPersistence.remove(idGestionPeticion);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Ocurrencia deleteOcurrencia(Ocurrencia ocurrencia)
		throws SystemException {
		return ocurrenciaPersistence.remove(ocurrencia);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Ocurrencia.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return ocurrenciaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return ocurrenciaPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return ocurrenciaPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Ocurrencia fetchOcurrencia(long idGestionPeticion)
		throws SystemException {
		return ocurrenciaPersistence.fetchByPrimaryKey(idGestionPeticion);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Ocurrencia getOcurrencia(long idGestionPeticion)
		throws PortalException, SystemException {
		return ocurrenciaPersistence.findByPrimaryKey(idGestionPeticion);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return ocurrenciaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Ocurrencia> getOcurrencias(int start, int end)
		throws SystemException {
		return ocurrenciaPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getOcurrenciasCount() throws SystemException {
		return ocurrenciaPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Ocurrencia updateOcurrencia(Ocurrencia ocurrencia)
		throws SystemException {
		return updateOcurrencia(ocurrencia, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Ocurrencia updateOcurrencia(Ocurrencia ocurrencia, boolean merge)
		throws SystemException {
		ocurrencia.setNew(false);

		return ocurrenciaPersistence.update(ocurrencia, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.Ocurrencia",
			ocurrenciaLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ext.portlet.halcon.model.Ocurrencia");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = ocurrenciaPersistence.getDataSource();
	...
	private OcurrenciaLocalServiceClpInvoker _clpInvoker = new OcurrenciaLocalServiceClpInvoker();
}