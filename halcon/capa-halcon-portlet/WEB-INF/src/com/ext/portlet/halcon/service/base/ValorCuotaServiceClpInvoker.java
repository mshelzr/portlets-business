 ...
 */
public class ValorCuotaServiceClpInvoker {
	public ValorCuotaServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName168.equals(name) &&
			...
			return ValorCuotaServiceUtil.getBeanIdentifier();
		}

		if (_methodName169.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes169, parameterTypes)) {
			ValorCuotaServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		}
