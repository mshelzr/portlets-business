...
/**
 * The base implementation of the solicitud producto local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.SolicitudProductoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SolicitudProductoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SolicitudProductoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.SolicitudProductoLocalServiceUtil} to access the solicitud producto local service.
	 */
	...
	public SolicitudProducto addSolicitudProducto(
		SolicitudProducto solicitudProducto) throws SystemException {
		solicitudProducto.setNew(true);

		return solicitudProductoPersistence.update(solicitudProducto, false);
	}
	 ...
	 */
	public SolicitudProducto createSolicitudProducto(long idSolicitudProducto) {
		return solicitudProductoPersistence.create(idSolicitudProducto);
	}
	...
	public SolicitudProducto deleteSolicitudProducto(long idSolicitudProducto)
		throws PortalException, SystemException {
		return solicitudProductoPersistence.remove(idSolicitudProducto);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SolicitudProducto deleteSolicitudProducto(
		SolicitudProducto solicitudProducto) throws SystemException {
		return solicitudProductoPersistence.remove(solicitudProducto);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SolicitudProducto.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return solicitudProductoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return solicitudProductoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SolicitudProducto fetchSolicitudProducto(long idSolicitudProducto)
		throws SystemException {
		return solicitudProductoPersistence.fetchByPrimaryKey(idSolicitudProducto);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SolicitudProducto getSolicitudProducto(long idSolicitudProducto)
		throws PortalException, SystemException {
		return solicitudProductoPersistence.findByPrimaryKey(idSolicitudProducto);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return solicitudProductoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SolicitudProducto> getSolicitudProductos(int start, int end)
		throws SystemException {
		return solicitudProductoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSolicitudProductosCount() throws SystemException {
		return solicitudProductoPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SolicitudProducto updateSolicitudProducto(
		SolicitudProducto solicitudProducto) throws SystemException {
		return updateSolicitudProducto(solicitudProducto, true);
	}
	...
	public SolicitudProducto updateSolicitudProducto(
		...
		return solicitudProductoPersistence.update(solicitudProducto, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.SolicitudProducto",
			solicitudProductoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = solicitudProductoPersistence.getDataSource();
	...
	private SolicitudProductoLocalServiceClpInvoker _clpInvoker = new SolicitudProductoLocalServiceClpInvoker();
}