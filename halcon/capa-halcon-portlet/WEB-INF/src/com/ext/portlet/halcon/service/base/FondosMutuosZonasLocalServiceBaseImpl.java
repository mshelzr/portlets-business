...
import com.ext.portlet.halcon.service.FondosMutuosZonasLocalService;
import com.ext.portlet.halcon.service.FondosMutuosZonasService;
...
import com.ext.portlet.halcon.service.persistence.FondosMutuosZonasPersistence;
...
/**
 * The base implementation of the fondos mutuos zonas local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.FondosMutuosZonasLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class FondosMutuosZonasLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FondosMutuosZonasLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.FondosMutuosZonasLocalServiceUtil} to access the fondos mutuos zonas local service.
	 */
	...
	public FondosMutuosZonas addFondosMutuosZonas(
		FondosMutuosZonas fondosMutuosZonas) throws SystemException {
		fondosMutuosZonas.setNew(true);

		return fondosMutuosZonasPersistence.update(fondosMutuosZonas, false);
	}
	 ...
	 */
	public FondosMutuosZonas createFondosMutuosZonas(long idFondoMutuoZona) {
		return fondosMutuosZonasPersistence.create(idFondoMutuoZona);
	}
	...
	public FondosMutuosZonas deleteFondosMutuosZonas(long idFondoMutuoZona)
		throws PortalException, SystemException {
		return fondosMutuosZonasPersistence.remove(idFondoMutuoZona);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FondosMutuosZonas deleteFondosMutuosZonas(
		FondosMutuosZonas fondosMutuosZonas) throws SystemException {
		return fondosMutuosZonasPersistence.remove(fondosMutuosZonas);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(FondosMutuosZonas.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return fondosMutuosZonasPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return fondosMutuosZonasPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public FondosMutuosZonas fetchFondosMutuosZonas(long idFondoMutuoZona)
		throws SystemException {
		return fondosMutuosZonasPersistence.fetchByPrimaryKey(idFondoMutuoZona);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FondosMutuosZonas getFondosMutuosZonas(long idFondoMutuoZona)
		throws PortalException, SystemException {
		return fondosMutuosZonasPersistence.findByPrimaryKey(idFondoMutuoZona);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return fondosMutuosZonasPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FondosMutuosZonas> getFondosMutuosZonases(int start, int end)
		throws SystemException {
		return fondosMutuosZonasPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFondosMutuosZonasesCount() throws SystemException {
		return fondosMutuosZonasPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FondosMutuosZonas updateFondosMutuosZonas(
		FondosMutuosZonas fondosMutuosZonas) throws SystemException {
		return updateFondosMutuosZonas(fondosMutuosZonas, true);
	}
	...
	public FondosMutuosZonas updateFondosMutuosZonas(
		...
		return fondosMutuosZonasPersistence.update(fondosMutuosZonas, merge);
	}
	...
	/**
	 * Returns the fondos mutuos zonas local service.
	 *
	 * @return the fondos mutuos zonas local service
	 */
	public FondosMutuosZonasLocalService getFondosMutuosZonasLocalService() {
		return fondosMutuosZonasLocalService;
	}

	/**
	 * Sets the fondos mutuos zonas local service.
	 *
	 * @param fondosMutuosZonasLocalService the fondos mutuos zonas local service
	 */
	public void setFondosMutuosZonasLocalService(
		FondosMutuosZonasLocalService fondosMutuosZonasLocalService) {
		this.fondosMutuosZonasLocalService = fondosMutuosZonasLocalService;
	}

	/**
	 * Returns the fondos mutuos zonas remote service.
	 *
	 * @return the fondos mutuos zonas remote service
	 */
	public FondosMutuosZonasService getFondosMutuosZonasService() {
		return fondosMutuosZonasService;
	}

	/**
	 * Sets the fondos mutuos zonas remote service.
	 *
	 * @param fondosMutuosZonasService the fondos mutuos zonas remote service
	 */
	public void setFondosMutuosZonasService(
		FondosMutuosZonasService fondosMutuosZonasService) {
		this.fondosMutuosZonasService = fondosMutuosZonasService;
	}

	/**
	 * Returns the fondos mutuos zonas persistence.
	 *
	 * @return the fondos mutuos zonas persistence
	 */
	public FondosMutuosZonasPersistence getFondosMutuosZonasPersistence() {
		return fondosMutuosZonasPersistence;
	}

	/**
	 * Sets the fondos mutuos zonas persistence.
	 *
	 * @param fondosMutuosZonasPersistence the fondos mutuos zonas persistence
	 */
	public void setFondosMutuosZonasPersistence(
		FondosMutuosZonasPersistence fondosMutuosZonasPersistence) {
		this.fondosMutuosZonasPersistence = fondosMutuosZonasPersistence;
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.FondosMutuosZonas",
			fondosMutuosZonasLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = fondosMutuosZonasPersistence.getDataSource();
	...
	@BeanReference(type = FondosMutuosZonasLocalService.class)
	protected FondosMutuosZonasLocalService fondosMutuosZonasLocalService;
	@BeanReference(type = FondosMutuosZonasService.class)
	protected FondosMutuosZonasService fondosMutuosZonasService;
	...
	private FondosMutuosZonasLocalServiceClpInvoker _clpInvoker = new FondosMutuosZonasLocalServiceClpInvoker();
}