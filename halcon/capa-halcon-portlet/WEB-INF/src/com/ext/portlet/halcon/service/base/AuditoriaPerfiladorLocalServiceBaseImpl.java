...
/**
 * The base implementation of the auditoria perfilador local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.AuditoriaPerfiladorLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class AuditoriaPerfiladorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AuditoriaPerfiladorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.AuditoriaPerfiladorLocalServiceUtil} to access the auditoria perfilador local service.
	 */
	...
	public AuditoriaPerfilador addAuditoriaPerfilador(
		AuditoriaPerfilador auditoriaPerfilador) throws SystemException {
		auditoriaPerfilador.setNew(true);

		return auditoriaPerfiladorPersistence.update(auditoriaPerfilador, false);
	}
	 ...
	 */
	public AuditoriaPerfilador createAuditoriaPerfilador(long idAuditoriaPer) {
		return auditoriaPerfiladorPersistence.create(idAuditoriaPer);
	}
	...
	public AuditoriaPerfilador deleteAuditoriaPerfilador(long idAuditoriaPer)
		throws PortalException, SystemException {
		return auditoriaPerfiladorPersistence.remove(idAuditoriaPer);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AuditoriaPerfilador deleteAuditoriaPerfilador(
		AuditoriaPerfilador auditoriaPerfilador) throws SystemException {
		return auditoriaPerfiladorPersistence.remove(auditoriaPerfilador);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AuditoriaPerfilador.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return auditoriaPerfiladorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return auditoriaPerfiladorPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AuditoriaPerfilador fetchAuditoriaPerfilador(long idAuditoriaPer)
		throws SystemException {
		return auditoriaPerfiladorPersistence.fetchByPrimaryKey(idAuditoriaPer);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AuditoriaPerfilador getAuditoriaPerfilador(long idAuditoriaPer)
		throws PortalException, SystemException {
		return auditoriaPerfiladorPersistence.findByPrimaryKey(idAuditoriaPer);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return auditoriaPerfiladorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AuditoriaPerfilador> getAuditoriaPerfiladors(int start, int end)
		throws SystemException {
		return auditoriaPerfiladorPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAuditoriaPerfiladorsCount() throws SystemException {
		return auditoriaPerfiladorPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AuditoriaPerfilador updateAuditoriaPerfilador(
		AuditoriaPerfilador auditoriaPerfilador) throws SystemException {
		return updateAuditoriaPerfilador(auditoriaPerfilador, true);
	}
	...
	public AuditoriaPerfilador updateAuditoriaPerfilador(
		...
		return auditoriaPerfiladorPersistence.update(auditoriaPerfilador, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.AuditoriaPerfilador",
			auditoriaPerfiladorLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = auditoriaPerfiladorPersistence.getDataSource();
	...
	private AuditoriaPerfiladorLocalServiceClpInvoker _clpInvoker = new AuditoriaPerfiladorLocalServiceClpInvoker();
}