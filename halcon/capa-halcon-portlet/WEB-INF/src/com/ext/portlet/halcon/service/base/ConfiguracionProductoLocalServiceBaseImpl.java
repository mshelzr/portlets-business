...
/**
 * The base implementation of the configuracion producto local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.ConfiguracionProductoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ConfiguracionProductoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ConfiguracionProductoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.ConfiguracionProductoLocalServiceUtil} to access the configuracion producto local service.
	 */
	...
	public ConfiguracionProducto addConfiguracionProducto(
		ConfiguracionProducto configuracionProducto) throws SystemException {
		configuracionProducto.setNew(true);

		return configuracionProductoPersistence.update(configuracionProducto,
			false);
	}
	 ...
	 */
	public ConfiguracionProducto createConfiguracionProducto(
		long idConfiguracionProducto) {
		return configuracionProductoPersistence.create(idConfiguracionProducto);
	}
	...
	public ConfiguracionProducto deleteConfiguracionProducto(
		long idConfiguracionProducto) throws PortalException, SystemException {
		return configuracionProductoPersistence.remove(idConfiguracionProducto);
	}
	...
	public ConfiguracionProducto deleteConfiguracionProducto(
		ConfiguracionProducto configuracionProducto) throws SystemException {
		return configuracionProductoPersistence.remove(configuracionProducto);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ConfiguracionProducto.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return configuracionProductoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return configuracionProductoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ConfiguracionProducto fetchConfiguracionProducto(
		long idConfiguracionProducto) throws SystemException {
		return configuracionProductoPersistence.fetchByPrimaryKey(idConfiguracionProducto);
	}
	...
	public ConfiguracionProducto getConfiguracionProducto(
		long idConfiguracionProducto) throws PortalException, SystemException {
		return configuracionProductoPersistence.findByPrimaryKey(idConfiguracionProducto);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return configuracionProductoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ConfiguracionProducto> getConfiguracionProductos(int start,
		int end) throws SystemException {
		return configuracionProductoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getConfiguracionProductosCount() throws SystemException {
		return configuracionProductoPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ConfiguracionProducto updateConfiguracionProducto(
		ConfiguracionProducto configuracionProducto) throws SystemException {
		return updateConfiguracionProducto(configuracionProducto, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.ConfiguracionProducto",
			configuracionProductoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = configuracionProductoPersistence.getDataSource();
	...
	private ConfiguracionProductoLocalServiceClpInvoker _clpInvoker = new ConfiguracionProductoLocalServiceClpInvoker();
}