...
/**
 * The base implementation of the auditoria caja sorpresa local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.AuditoriaCajaSorpresaLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class AuditoriaCajaSorpresaLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AuditoriaCajaSorpresaLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.AuditoriaCajaSorpresaLocalServiceUtil} to access the auditoria caja sorpresa local service.
	 */
	...
	public AuditoriaCajaSorpresa addAuditoriaCajaSorpresa(
		AuditoriaCajaSorpresa auditoriaCajaSorpresa) throws SystemException {
		auditoriaCajaSorpresa.setNew(true);

		return auditoriaCajaSorpresaPersistence.update(auditoriaCajaSorpresa,
			false);
	}
	 ...
	 */
	public AuditoriaCajaSorpresa createAuditoriaCajaSorpresa(
		long idAuditoriaCajSorp) {
		return auditoriaCajaSorpresaPersistence.create(idAuditoriaCajSorp);
	}
	...
	public AuditoriaCajaSorpresa deleteAuditoriaCajaSorpresa(
		long idAuditoriaCajSorp) throws PortalException, SystemException {
		return auditoriaCajaSorpresaPersistence.remove(idAuditoriaCajSorp);
	}
	...
	public AuditoriaCajaSorpresa deleteAuditoriaCajaSorpresa(
		AuditoriaCajaSorpresa auditoriaCajaSorpresa) throws SystemException {
		return auditoriaCajaSorpresaPersistence.remove(auditoriaCajaSorpresa);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AuditoriaCajaSorpresa.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return auditoriaCajaSorpresaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return auditoriaCajaSorpresaPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AuditoriaCajaSorpresa fetchAuditoriaCajaSorpresa(
		long idAuditoriaCajSorp) throws SystemException {
		return auditoriaCajaSorpresaPersistence.fetchByPrimaryKey(idAuditoriaCajSorp);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AuditoriaCajaSorpresa getAuditoriaCajaSorpresa(
		long idAuditoriaCajSorp) throws PortalException, SystemException {
		return auditoriaCajaSorpresaPersistence.findByPrimaryKey(idAuditoriaCajSorp);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return auditoriaCajaSorpresaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AuditoriaCajaSorpresa> getAuditoriaCajaSorpresas(int start,
		int end) throws SystemException {
		return auditoriaCajaSorpresaPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAuditoriaCajaSorpresasCount() throws SystemException {
		return auditoriaCajaSorpresaPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AuditoriaCajaSorpresa updateAuditoriaCajaSorpresa(
		AuditoriaCajaSorpresa auditoriaCajaSorpresa) throws SystemException {
		return updateAuditoriaCajaSorpresa(auditoriaCajaSorpresa, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.AuditoriaCajaSorpresa",
			auditoriaCajaSorpresaLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = auditoriaCajaSorpresaPersistence.getDataSource();
	...
	private AuditoriaCajaSorpresaLocalServiceClpInvoker _clpInvoker = new AuditoriaCajaSorpresaLocalServiceClpInvoker();
}