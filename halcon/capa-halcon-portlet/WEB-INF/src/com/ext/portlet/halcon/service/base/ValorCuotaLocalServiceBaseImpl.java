...
/**
 * The base implementation of the valor cuota local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.ValorCuotaLocalServiceImpl}.
 * </p>
 *
 * @author Infonet-Consulting
 * @see com.ext.portlet.halcon.service.impl.ValorCuotaLocalServiceImpl
 * @see com.ext.portlet.halcon.service.ValorCuotaLocalServiceUtil
 * @generated
 */
public abstract class ValorCuotaLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ValorCuotaLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.ValorCuotaLocalServiceUtil} to access the valor cuota local service.
	 */
	...
	public ValorCuota addValorCuota(ValorCuota valorCuota)
		throws SystemException {
		valorCuota.setNew(true);

		return valorCuotaPersistence.update(valorCuota, false);
	}
	 ...
	 */
	public ValorCuota createValorCuota(long IdValorCuota) {
		return valorCuotaPersistence.create(IdValorCuota);
	}
	...
	public ValorCuota deleteValorCuota(long IdValorCuota)
		throws PortalException, SystemException {
		return valorCuotaPersistence.remove(IdValorCuota);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ValorCuota deleteValorCuota(ValorCuota valorCuota)
		throws SystemException {
		return valorCuotaPersistence.remove(valorCuota);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ValorCuota.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return valorCuotaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return valorCuotaPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return valorCuotaPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ValorCuota fetchValorCuota(long IdValorCuota)
		throws SystemException {
		return valorCuotaPersistence.fetchByPrimaryKey(IdValorCuota);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ValorCuota getValorCuota(long IdValorCuota)
		throws PortalException, SystemException {
		return valorCuotaPersistence.findByPrimaryKey(IdValorCuota);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return valorCuotaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ValorCuota> getValorCuotas(int start, int end)
		throws SystemException {
		return valorCuotaPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getValorCuotasCount() throws SystemException {
		return valorCuotaPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ValorCuota updateValorCuota(ValorCuota valorCuota)
		throws SystemException {
		return updateValorCuota(valorCuota, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ValorCuota updateValorCuota(ValorCuota valorCuota, boolean merge)
		throws SystemException {
		valorCuota.setNew(false);

		return valorCuotaPersistence.update(valorCuota, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.ValorCuota",
			valorCuotaLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = valorCuotaPersistence.getDataSource();
	...
	private ValorCuotaLocalServiceClpInvoker _clpInvoker = new ValorCuotaLocalServiceClpInvoker();
}