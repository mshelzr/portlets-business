...
/**
 * The base implementation of the solicitud contacto local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.SolicitudContactoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SolicitudContactoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SolicitudContactoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.SolicitudContactoLocalServiceUtil} to access the solicitud contacto local service.
	 */
	...
	public SolicitudContacto addSolicitudContacto(
		SolicitudContacto solicitudContacto) throws SystemException {
		solicitudContacto.setNew(true);

		return solicitudContactoPersistence.update(solicitudContacto, false);
	}
	 ...
	 */
	public SolicitudContacto createSolicitudContacto(long idSolicitudContacto) {
		return solicitudContactoPersistence.create(idSolicitudContacto);
	}
	...
	public SolicitudContacto deleteSolicitudContacto(long idSolicitudContacto)
		throws PortalException, SystemException {
		return solicitudContactoPersistence.remove(idSolicitudContacto);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SolicitudContacto deleteSolicitudContacto(
		SolicitudContacto solicitudContacto) throws SystemException {
		return solicitudContactoPersistence.remove(solicitudContacto);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SolicitudContacto.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return solicitudContactoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return solicitudContactoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SolicitudContacto fetchSolicitudContacto(long idSolicitudContacto)
		throws SystemException {
		return solicitudContactoPersistence.fetchByPrimaryKey(idSolicitudContacto);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SolicitudContacto getSolicitudContacto(long idSolicitudContacto)
		throws PortalException, SystemException {
		return solicitudContactoPersistence.findByPrimaryKey(idSolicitudContacto);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return solicitudContactoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SolicitudContacto> getSolicitudContactos(int start, int end)
		throws SystemException {
		return solicitudContactoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSolicitudContactosCount() throws SystemException {
		return solicitudContactoPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SolicitudContacto updateSolicitudContacto(
		SolicitudContacto solicitudContacto) throws SystemException {
		return updateSolicitudContacto(solicitudContacto, true);
	}
	...
	public SolicitudContacto updateSolicitudContacto(
		...
		return solicitudContactoPersistence.update(solicitudContacto, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.SolicitudContacto",
			solicitudContactoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ext.portlet.halcon.model.SolicitudContacto");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = solicitudContactoPersistence.getDataSource();
	...
	private SolicitudContactoLocalServiceClpInvoker _clpInvoker = new SolicitudContactoLocalServiceClpInvoker();
}