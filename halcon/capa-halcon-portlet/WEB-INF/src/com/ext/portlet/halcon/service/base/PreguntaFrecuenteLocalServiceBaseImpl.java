...
/**
 * The base implementation of the pregunta frecuente local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.PreguntaFrecuenteLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PreguntaFrecuenteLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PreguntaFrecuenteLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.PreguntaFrecuenteLocalServiceUtil} to access the pregunta frecuente local service.
	 */
	...
	public PreguntaFrecuente addPreguntaFrecuente(
		PreguntaFrecuente preguntaFrecuente) throws SystemException {
		preguntaFrecuente.setNew(true);

		return preguntaFrecuentePersistence.update(preguntaFrecuente, false);
	}
	 ...
	 */
	public PreguntaFrecuente createPreguntaFrecuente(int idPreguntaFrecuente) {
		return preguntaFrecuentePersistence.create(idPreguntaFrecuente);
	}
	...
	public PreguntaFrecuente deletePreguntaFrecuente(int idPreguntaFrecuente)
		throws PortalException, SystemException {
		return preguntaFrecuentePersistence.remove(idPreguntaFrecuente);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PreguntaFrecuente deletePreguntaFrecuente(
		PreguntaFrecuente preguntaFrecuente) throws SystemException {
		return preguntaFrecuentePersistence.remove(preguntaFrecuente);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PreguntaFrecuente.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return preguntaFrecuentePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return preguntaFrecuentePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PreguntaFrecuente fetchPreguntaFrecuente(int idPreguntaFrecuente)
		throws SystemException {
		return preguntaFrecuentePersistence.fetchByPrimaryKey(idPreguntaFrecuente);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PreguntaFrecuente getPreguntaFrecuente(int idPreguntaFrecuente)
		throws PortalException, SystemException {
		return preguntaFrecuentePersistence.findByPrimaryKey(idPreguntaFrecuente);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return preguntaFrecuentePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PreguntaFrecuente> getPreguntaFrecuentes(int start, int end)
		throws SystemException {
		return preguntaFrecuentePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPreguntaFrecuentesCount() throws SystemException {
		return preguntaFrecuentePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PreguntaFrecuente updatePreguntaFrecuente(
		PreguntaFrecuente preguntaFrecuente) throws SystemException {
		return updatePreguntaFrecuente(preguntaFrecuente, true);
	}
	...
	public PreguntaFrecuente updatePreguntaFrecuente(
		...
		return preguntaFrecuentePersistence.update(preguntaFrecuente, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.PreguntaFrecuente",
			preguntaFrecuenteLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ext.portlet.halcon.model.PreguntaFrecuente");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = preguntaFrecuentePersistence.getDataSource();
	...
	private PreguntaFrecuenteLocalServiceClpInvoker _clpInvoker = new PreguntaFrecuenteLocalServiceClpInvoker();
}