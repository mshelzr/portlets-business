...
/**
 * The base implementation of the producto complementario local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.ProductoComplementarioLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProductoComplementarioLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProductoComplementarioLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.ProductoComplementarioLocalServiceUtil} to access the producto complementario local service.
	 */
	...
	public ProductoComplementario addProductoComplementario(
		ProductoComplementario productoComplementario)
		throws SystemException {
		productoComplementario.setNew(true);

		return productoComplementarioPersistence.update(productoComplementario,
			false);
	}
	 ...
	 */
	public ProductoComplementario createProductoComplementario(
		long idProductoComplementario) {
		return productoComplementarioPersistence.create(idProductoComplementario);
	}
	...
	public ProductoComplementario deleteProductoComplementario(
		long idProductoComplementario) throws PortalException, SystemException {
		return productoComplementarioPersistence.remove(idProductoComplementario);
	}
	...
	public ProductoComplementario deleteProductoComplementario(
		ProductoComplementario productoComplementario)
		throws SystemException {
		return productoComplementarioPersistence.remove(productoComplementario);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ProductoComplementario.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return productoComplementarioPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return productoComplementarioPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ProductoComplementario fetchProductoComplementario(
		long idProductoComplementario) throws SystemException {
		return productoComplementarioPersistence.fetchByPrimaryKey(idProductoComplementario);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ProductoComplementario getProductoComplementario(
		long idProductoComplementario) throws PortalException, SystemException {
		return productoComplementarioPersistence.findByPrimaryKey(idProductoComplementario);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return productoComplementarioPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ProductoComplementario> getProductoComplementarios(int start,
		int end) throws SystemException {
		return productoComplementarioPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getProductoComplementariosCount() throws SystemException {
		return productoComplementarioPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ProductoComplementario updateProductoComplementario(
		ProductoComplementario productoComplementario)
		throws SystemException {
		return updateProductoComplementario(productoComplementario, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.ProductoComplementario",
			productoComplementarioLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ext.portlet.halcon.model.ProductoComplementario");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = productoComplementarioPersistence.getDataSource();
	...
	private ProductoComplementarioLocalServiceClpInvoker _clpInvoker = new ProductoComplementarioLocalServiceClpInvoker();
}