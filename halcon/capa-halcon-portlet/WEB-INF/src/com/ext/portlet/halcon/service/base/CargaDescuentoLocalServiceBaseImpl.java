...
/**
 * The base implementation of the carga descuento local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.CargaDescuentoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CargaDescuentoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CargaDescuentoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.CargaDescuentoLocalServiceUtil} to access the carga descuento local service.
	 */
	...
	public CargaDescuento addCargaDescuento(CargaDescuento cargaDescuento)
		throws SystemException {
		cargaDescuento.setNew(true);

		return cargaDescuentoPersistence.update(cargaDescuento, false);
	}
	 ...
	 */
	public CargaDescuento createCargaDescuento(long idCargaDesc) {
		return cargaDescuentoPersistence.create(idCargaDesc);
	}
	...
	public CargaDescuento deleteCargaDescuento(long idCargaDesc)
		throws PortalException, SystemException {
		return cargaDescuentoPersistence.remove(idCargaDesc);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CargaDescuento deleteCargaDescuento(CargaDescuento cargaDescuento)
		throws SystemException {
		return cargaDescuentoPersistence.remove(cargaDescuento);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CargaDescuento.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return cargaDescuentoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cargaDescuentoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CargaDescuento fetchCargaDescuento(long idCargaDesc)
		throws SystemException {
		return cargaDescuentoPersistence.fetchByPrimaryKey(idCargaDesc);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CargaDescuento getCargaDescuento(long idCargaDesc)
		throws PortalException, SystemException {
		return cargaDescuentoPersistence.findByPrimaryKey(idCargaDesc);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cargaDescuentoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CargaDescuento> getCargaDescuentos(int start, int end)
		throws SystemException {
		return cargaDescuentoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCargaDescuentosCount() throws SystemException {
		return cargaDescuentoPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CargaDescuento updateCargaDescuento(CargaDescuento cargaDescuento)
		throws SystemException {
		return updateCargaDescuento(cargaDescuento, true);
	}
	...
	public CargaDescuento updateCargaDescuento(CargaDescuento cargaDescuento,
		...
		return cargaDescuentoPersistence.update(cargaDescuento, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.CargaDescuento",
			cargaDescuentoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cargaDescuentoPersistence.getDataSource();
	...
	private CargaDescuentoLocalServiceClpInvoker _clpInvoker = new CargaDescuentoLocalServiceClpInvoker();
}