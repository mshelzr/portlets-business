...
/**
 * The base implementation of the ubigeo local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.UbigeoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class UbigeoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UbigeoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.UbigeoLocalServiceUtil} to access the ubigeo local service.
	 */
	...
	public Ubigeo addUbigeo(Ubigeo ubigeo) throws SystemException {
		ubigeo.setNew(true);

		return ubigeoPersistence.update(ubigeo, false);
	}
	 ...
	 */
	public Ubigeo createUbigeo(long idUbigeo) {
		return ubigeoPersistence.create(idUbigeo);
	}
	...
	public Ubigeo deleteUbigeo(long idUbigeo)
		throws PortalException, SystemException {
		return ubigeoPersistence.remove(idUbigeo);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Ubigeo deleteUbigeo(Ubigeo ubigeo) throws SystemException {
		return ubigeoPersistence.remove(ubigeo);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Ubigeo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return ubigeoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return ubigeoPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return ubigeoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Ubigeo fetchUbigeo(long idUbigeo) throws SystemException {
		return ubigeoPersistence.fetchByPrimaryKey(idUbigeo);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Ubigeo getUbigeo(long idUbigeo)
		throws PortalException, SystemException {
		return ubigeoPersistence.findByPrimaryKey(idUbigeo);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return ubigeoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Ubigeo> getUbigeos(int start, int end)
		throws SystemException {
		return ubigeoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getUbigeosCount() throws SystemException {
		return ubigeoPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Ubigeo updateUbigeo(Ubigeo ubigeo) throws SystemException {
		return updateUbigeo(ubigeo, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Ubigeo updateUbigeo(Ubigeo ubigeo, boolean merge)
		throws SystemException {
		ubigeo.setNew(false);

		return ubigeoPersistence.update(ubigeo, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.Ubigeo",
			ubigeoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ext.portlet.halcon.model.Ubigeo");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = ubigeoPersistence.getDataSource();
	...
	private UbigeoLocalServiceClpInvoker _clpInvoker = new UbigeoLocalServiceClpInvoker();
}