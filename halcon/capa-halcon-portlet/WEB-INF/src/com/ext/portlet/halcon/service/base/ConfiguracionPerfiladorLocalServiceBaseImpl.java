...
/**
 * The base implementation of the configuracion perfilador local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.ConfiguracionPerfiladorLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ConfiguracionPerfiladorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ConfiguracionPerfiladorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.ConfiguracionPerfiladorLocalServiceUtil} to access the configuracion perfilador local service.
	 */
	...
	public ConfiguracionPerfilador addConfiguracionPerfilador(
		ConfiguracionPerfilador configuracionPerfilador)
		throws SystemException {
		configuracionPerfilador.setNew(true);

		return configuracionPerfiladorPersistence.update(configuracionPerfilador,
			false);
	}
	 ...
	 */
	public ConfiguracionPerfilador createConfiguracionPerfilador(
		long idConfiguracionPerfilador) {
		return configuracionPerfiladorPersistence.create(idConfiguracionPerfilador);
	}
	...
	public ConfiguracionPerfilador deleteConfiguracionPerfilador(
		long idConfiguracionPerfilador) throws PortalException, SystemException {
		return configuracionPerfiladorPersistence.remove(idConfiguracionPerfilador);
	}
	...
	public ConfiguracionPerfilador deleteConfiguracionPerfilador(
		ConfiguracionPerfilador configuracionPerfilador)
		throws SystemException {
		return configuracionPerfiladorPersistence.remove(configuracionPerfilador);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ConfiguracionPerfilador.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return configuracionPerfiladorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return configuracionPerfiladorPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ConfiguracionPerfilador fetchConfiguracionPerfilador(
		long idConfiguracionPerfilador) throws SystemException {
		return configuracionPerfiladorPersistence.fetchByPrimaryKey(idConfiguracionPerfilador);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ConfiguracionPerfilador getConfiguracionPerfilador(
		long idConfiguracionPerfilador) throws PortalException, SystemException {
		return configuracionPerfiladorPersistence.findByPrimaryKey(idConfiguracionPerfilador);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return configuracionPerfiladorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ConfiguracionPerfilador> getConfiguracionPerfiladors(
		int start, int end) throws SystemException {
		return configuracionPerfiladorPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getConfiguracionPerfiladorsCount() throws SystemException {
		return configuracionPerfiladorPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ConfiguracionPerfilador updateConfiguracionPerfilador(
		ConfiguracionPerfilador configuracionPerfilador)
		throws SystemException {
		return updateConfiguracionPerfilador(configuracionPerfilador, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.ConfiguracionPerfilador",
			configuracionPerfiladorLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = configuracionPerfiladorPersistence.getDataSource();
	...
	private ConfiguracionPerfiladorLocalServiceClpInvoker _clpInvoker = new ConfiguracionPerfiladorLocalServiceClpInvoker();
}