...
/**
 * The base implementation of the fondos mutuos local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.FondosMutuosLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class FondosMutuosLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FondosMutuosLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.FondosMutuosLocalServiceUtil} to access the fondos mutuos local service.
	 */
	...
	public FondosMutuos addFondosMutuos(FondosMutuos fondosMutuos)
		throws SystemException {
		fondosMutuos.setNew(true);

		return fondosMutuosPersistence.update(fondosMutuos, false);
	}
	 ...
	 */
	public FondosMutuos createFondosMutuos(long idValorCuota) {
		return fondosMutuosPersistence.create(idValorCuota);
	}
	...
	public FondosMutuos deleteFondosMutuos(long idValorCuota)
		throws PortalException, SystemException {
		return fondosMutuosPersistence.remove(idValorCuota);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FondosMutuos deleteFondosMutuos(FondosMutuos fondosMutuos)
		throws SystemException {
		return fondosMutuosPersistence.remove(fondosMutuos);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(FondosMutuos.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return fondosMutuosPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return fondosMutuosPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public FondosMutuos fetchFondosMutuos(long idValorCuota)
		throws SystemException {
		return fondosMutuosPersistence.fetchByPrimaryKey(idValorCuota);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FondosMutuos getFondosMutuos(long idValorCuota)
		throws PortalException, SystemException {
		return fondosMutuosPersistence.findByPrimaryKey(idValorCuota);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return fondosMutuosPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FondosMutuos> getFondosMutuoses(int start, int end)
		throws SystemException {
		return fondosMutuosPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFondosMutuosesCount() throws SystemException {
		return fondosMutuosPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FondosMutuos updateFondosMutuos(FondosMutuos fondosMutuos)
		throws SystemException {
		return updateFondosMutuos(fondosMutuos, true);
	}
	...
	public FondosMutuos updateFondosMutuos(FondosMutuos fondosMutuos,
		...
		return fondosMutuosPersistence.update(fondosMutuos, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.FondosMutuos",
			fondosMutuosLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = fondosMutuosPersistence.getDataSource();
	...
	private FondosMutuosLocalServiceClpInvoker _clpInvoker = new FondosMutuosLocalServiceClpInvoker();
}