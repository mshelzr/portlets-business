...
/**
 * The base implementation of the parametro local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.ParametroLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ParametroLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ParametroLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.ParametroLocalServiceUtil} to access the parametro local service.
	 */
	...
	public Parametro addParametro(Parametro parametro)
		...
		return parametroPersistence.update(parametro, false);
	}
	 ...
	 */
	public Parametro createParametro(int idParametro) {
		return parametroPersistence.create(idParametro);
	}
	...
	public Parametro deleteParametro(int idParametro)
		throws PortalException, SystemException {
		return parametroPersistence.remove(idParametro);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Parametro.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return parametroPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public Parametro fetchParametro(int idParametro) throws SystemException {
		return parametroPersistence.fetchByPrimaryKey(idParametro);
	}
	...
	public Parametro getParametro(int idParametro)
		throws PortalException, SystemException {
		return parametroPersistence.findByPrimaryKey(idParametro);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getParametrosCount() throws SystemException {
	...
	public Parametro updateParametro(Parametro parametro)
		throws SystemException {
		return updateParametro(parametro, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Parametro updateParametro(Parametro parametro, boolean merge)
		throws SystemException {
		parametro.setNew(false);

		return parametroPersistence.update(parametro, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.Parametro",
	...
	private ParametroLocalServiceClpInvoker _clpInvoker = new ParametroLocalServiceClpInvoker();
}