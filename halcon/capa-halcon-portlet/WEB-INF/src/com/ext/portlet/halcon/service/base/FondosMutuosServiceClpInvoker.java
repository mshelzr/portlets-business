 ...
 */
public class FondosMutuosServiceClpInvoker {
	public FondosMutuosServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName168.equals(name) &&
			...
			return FondosMutuosServiceUtil.getBeanIdentifier();
		}

		if (_methodName169.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes169, parameterTypes)) {
			FondosMutuosServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		}
