...
/**
 * The base implementation of the auditoria simulador local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.halcon.service.impl.AuditoriaSimuladorLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class AuditoriaSimuladorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AuditoriaSimuladorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.halcon.service.AuditoriaSimuladorLocalServiceUtil} to access the auditoria simulador local service.
	 */
	...
	public AuditoriaSimulador addAuditoriaSimulador(
		AuditoriaSimulador auditoriaSimulador) throws SystemException {
		auditoriaSimulador.setNew(true);

		return auditoriaSimuladorPersistence.update(auditoriaSimulador, false);
	}
	 ...
	 */
	public AuditoriaSimulador createAuditoriaSimulador(long idAuditoriaSim) {
		return auditoriaSimuladorPersistence.create(idAuditoriaSim);
	}
	...
	public AuditoriaSimulador deleteAuditoriaSimulador(long idAuditoriaSim)
		throws PortalException, SystemException {
		return auditoriaSimuladorPersistence.remove(idAuditoriaSim);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AuditoriaSimulador deleteAuditoriaSimulador(
		AuditoriaSimulador auditoriaSimulador) throws SystemException {
		return auditoriaSimuladorPersistence.remove(auditoriaSimulador);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AuditoriaSimulador.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return auditoriaSimuladorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return auditoriaSimuladorPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AuditoriaSimulador fetchAuditoriaSimulador(long idAuditoriaSim)
		throws SystemException {
		return auditoriaSimuladorPersistence.fetchByPrimaryKey(idAuditoriaSim);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AuditoriaSimulador getAuditoriaSimulador(long idAuditoriaSim)
		throws PortalException, SystemException {
		return auditoriaSimuladorPersistence.findByPrimaryKey(idAuditoriaSim);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return auditoriaSimuladorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AuditoriaSimulador> getAuditoriaSimuladors(int start, int end)
		throws SystemException {
		return auditoriaSimuladorPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAuditoriaSimuladorsCount() throws SystemException {
		return auditoriaSimuladorPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AuditoriaSimulador updateAuditoriaSimulador(
		AuditoriaSimulador auditoriaSimulador) throws SystemException {
		return updateAuditoriaSimulador(auditoriaSimulador, true);
	}
	...
	public AuditoriaSimulador updateAuditoriaSimulador(
		...
		return auditoriaSimuladorPersistence.update(auditoriaSimulador, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.halcon.model.AuditoriaSimulador",
			auditoriaSimuladorLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = auditoriaSimuladorPersistence.getDataSource();
	...
	private AuditoriaSimuladorLocalServiceClpInvoker _clpInvoker = new AuditoriaSimuladorLocalServiceClpInvoker();
}