<%@page import="com.ext.portlet.halcon.dto.ProductoComplementarioBean"%>
...
<form action="/solicitud/credito-vehicular/2" method="post"
...
<input type="hidden" id="urlPaso1_cv" value='<portlet:resourceURL id="paso1_cv"/>' />
<input type="hidden" id="checkCodProducto" name="checkCodProducto" value="${checkCodProducto}" />
<input type="hidden" id="RANGO_PLAZO_CREDITO_VEHICULAR" name="RANGO_PLAZO_CREDITO_VEHICULAR" value='${RANGO_SLIDER_PERFILADOR_VEHICULAR}' />
...
<input type="hidden" id="estadoPaso1Vehicular" name="estadoPaso1Vehicular" value="${requestScope.estadoPaso1Vehicular}" />
<input type="hidden" id="estadoPaso2Vehicular" name="estadoPaso2Vehicular" value="${requestScope.estadoPaso2Vehicular}" />