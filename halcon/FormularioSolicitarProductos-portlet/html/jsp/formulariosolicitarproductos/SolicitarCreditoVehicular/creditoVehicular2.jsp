...
<form action="/solicitud/credito-vehicular/3" method="post" name="<portlet:namespace/>fm2" id="<portlet:namespace/>fm2">
...
<input type="hidden" id="urlPaso2_cv" value='<portlet:resourceURL id="paso2_cv"/>'/>
