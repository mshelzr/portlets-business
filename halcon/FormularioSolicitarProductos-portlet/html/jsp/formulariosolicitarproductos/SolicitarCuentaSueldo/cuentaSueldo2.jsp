...
<input id="validarCaptchaSolicitudes" type="hidden"
	value="<portlet:resourceURL id="validarCaptchaSolicitudes" />" />
<input id="urlImagen" type="hidden"
	value="<portlet:resourceURL id="traerImagen" />" />
<portlet:resourceURL var="traerImagen" id="traerImagen" />

<form action="/solicitud/cuenta-sueldo/3" method="post"
	name="<portlet:namespace/>fm2" id="<portlet:namespace/>fm2">
	<input type="hidden" id="hiddenF2" name="hiddenF2"
		value="<portlet:namespace/>fm2" />
	<!--content-medio-->
	<div class="sol2" id="content-medio">
		...
		<c:set var="valorDepartamento" value="0"/>
          <c:choose> 
			...
			<div class="campos-oblig">
				...
				<div class="valid['rdropdown'] dropdown wt140 float-left" id="cbodepartamento">
		...
		<div class="recaptcha soli-codigo anula-fl-mg">
			<div class="bosrde" >
        	<img src="${traerImagen}" width="106" height="28" id="imgCaptcha" title="Captcha"/>
        	 </div>
			<div class="codigo-icons">
				<em class="volver" href="javascript:void(0)" onclick="actualizarImagen()"></em> <em class="tool">
					<div class="tool-open">Escribe los caracteres de la imagen en
						el siguiente cuadro.</div>
				</em>
			</div>
		...
		<div class="soli-botones padt15">
			<div class="next-sol regresar con-decoration sin-margin"> &lt; <a title="Regresar" href="javascript:;" id="btn2Atras">Regresar</a></div>
...
<input type="hidden" id="urlPaso2_cs" value='<portlet:resourceURL id="paso2_cs"/>'/>
