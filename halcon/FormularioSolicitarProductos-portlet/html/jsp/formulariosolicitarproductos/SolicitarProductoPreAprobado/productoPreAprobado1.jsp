...
<form action="/solicitud/producto-preaprobado/2" method="post" name="<portlet:namespace/>fm1" id="<portlet:namespace/>fm1">
<input type="hidden" id="hiddenF1" name="hiddenF1" value="<portlet:namespace/>fm1" />	
    ...
    <div id="content-medio" class="sol">
      ...
      <div class="sol-formulario">
          ...
          <label>Tipo de Documento</label>
 			 ...
 			 <input type="hidden" id="tipDoc1" name="tipDoc1" value="${valorHiddenTipoDoc}" />
				...
				<input type="text" class="textform1 wt115 margin-left9 float-left"
					...
					placeholder="N° de Documento" readonly="readonly"/>
			</div>
        ...
        <div class="form-error">Debes ingresar el Segundo Nombre
        </div>
...
<input type="hidden" id="urlPaso1_ppa" value='<portlet:resourceURL id="paso1_ppa"/>'/>
...
<input type="hidden" id="estadoPaso1Aprobado" name="estadoPaso1Aprobado" value="${requestScope.estadoPaso1Aprobado}" />
<input type="hidden" id="estadoPaso2Aprobado" name="estadoPaso2Aprobado" value="${requestScope.estadoPaso2Aprobado}" />  