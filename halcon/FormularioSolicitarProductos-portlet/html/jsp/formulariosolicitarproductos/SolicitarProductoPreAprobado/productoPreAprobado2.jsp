...
<form action="/solicitud/producto-preaprobado/3" method="post" name="<portlet:namespace/>fm2" id="<portlet:namespace/>fm2">
    ...
    <div id="content-medio" class="sol2">
      ...
      <c:set var="valorDepartamento" value="0"/>
        ...
        <div class="campos-oblig">
          ...
          <div class="valid['rdropdown'] dropdown2 wt190 float-left bgfa cbodepartamento" id="cbodepartamento">
...
<input type="hidden" id="urlPaso2_ppa" value='<portlet:resourceURL id="paso2_ppa"/>'/>
