...
<form action="/solicitud/tarjeta-credito/4" method="post" name="<portlet:namespace/>fm3" id="<portlet:namespace/>fm3" enctype="multipart/form-data">
    ...
    <div id="content-medio" class="sol3">
      ...
      <div id="paso3" class="sol-formulario paso3" name="paso3">
        ...
        <div class="campos-oblig-dos">
          ...
          <p id="mostrarEstadoCivil"><%=cboestadocivil%>
          </p>
        </div>
        <div class="campos-oblig-dos">
          <label>Situaci&oacute;n Laboral</label>
          <p id="mostrarSituacionLaboral"><%=cbosituacionlaboral%>
          </p>
        </div>
        <div class="campos-oblig-dos">
          <label>RUC</label>
        ...
        <div class="campos-oblig-dos">
          ...
          <p id="mostrarRentaMensual"><%=valorRenta%>
          </p>
        </div>
        <div class="campos-oblig-dos">
...
<input type="hidden" id="urlPaso3_tj" value='<portlet:resourceURL id="paso3_tj"/>'/>
