...
<form action="/solicitud/tarjeta-credito/3" method="post" name="<portlet:namespace/>fm2" id="<portlet:namespace/>fm2">
...
<input type="hidden" id="urlPaso2_tj" value='<portlet:resourceURL id="paso2_tj"/>'/>
