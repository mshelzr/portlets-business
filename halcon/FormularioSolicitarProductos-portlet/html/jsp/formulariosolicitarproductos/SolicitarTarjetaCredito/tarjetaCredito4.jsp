<%@page import="pe.com.ibk.halcon.solicitudes.utils.Constantes"%>
...
<!-- Facebook Conversion Code for Tarjetas de Crédito - Halcón -->
<script type="text/javascript">
var fb_param = {};
fb_param.pixel_id = '6015629332126';
fb_param.value = '0.00';
...
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/offsite_event.php?id=6015629332126&amp;value=0&amp;currency=USD" /></noscript>
...
String cboestadocivil=(String)pSession.getAttribute("cboestadocivilTexto");
String cbosituacionlaboral=(String)pSession.getAttribute("cbosituacionlaboralTexto");
...
Integer errorPreCalificacion=(Integer) pSession.getAttribute("errorPreCalificacion");
...
<c:set var="error" value="<%=error%>" />
 ...
 <div class=""> 
    <!--content-medio-->
   <div id="content-medio" class="sol4"> 
