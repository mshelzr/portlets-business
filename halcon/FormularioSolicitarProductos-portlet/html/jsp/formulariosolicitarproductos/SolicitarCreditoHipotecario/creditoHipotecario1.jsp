...
<form action="/solicitud/credito-hipotecario/2" method="post"
	...
	<div id="content-medio" class="sol">
		...
		<div class="sol-formulario">
			...
			<div class="campos-oblig">
				<label>Apellido Materno</label> <input type="text" class="valid['optionalalphaNumericGroup2'] textform1 wt224 float-left" value="<%=apeMater%>" id="apeMater" name="apeMater" maxLength="50" />
			</div>
...
<input type="hidden" id="urlPaso1_ch" value='<portlet:resourceURL id="paso1_ch"/>' />
<input type="hidden" id="checkCodProducto" name="checkCodProducto" value="${checkCodProducto}" />
<input type="hidden" id="RANGO_PLAZO_CREDITO_HIPOTECARIO" name="RANGO_PLAZO_CREDITO_HIPOTECARIO" value='${RANGO_SLIDER_PERFILADOR_HIPOTECARIO}' />
