...
<form action="/solicitud/credito-hipotecario/3" method="post" name="<portlet:namespace/>fm2" id="<portlet:namespace/>fm2">
...
<input type="hidden" id="urlPaso2_ch" value='<portlet:resourceURL id="paso2_ch"/>'/>
