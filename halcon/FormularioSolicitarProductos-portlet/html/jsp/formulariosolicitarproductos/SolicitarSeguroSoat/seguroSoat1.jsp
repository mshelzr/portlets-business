...
<form action="/solicitud/seguro-soat/2" method="post" name="<portlet:namespace/>fm1" id="<portlet:namespace/>fm1">
...
<input type="hidden" id="urlPaso1_ss" value='<portlet:resourceURL id="paso1_ss"/>'/>
