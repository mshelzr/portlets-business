...
<form action="/solicitud/fondos-mutuos/2" method="post" name="<portlet:namespace/>fm1" id="<portlet:namespace/>fm1">
...
<input type="hidden" id="urlPaso1_fm" value='<portlet:resourceURL id="paso1_fm"/>'/>
...
<input type="hidden" id="estadoPaso1Mutuos" name="estadoPaso1Mutuos" value="${requestScope.estadoPaso1Mutuos}" />
<input type="hidden" id="estadoPaso2Mutuos" name="estadoPaso2Mutuos" value="${requestScope.estadoPaso2Mutuos}" />