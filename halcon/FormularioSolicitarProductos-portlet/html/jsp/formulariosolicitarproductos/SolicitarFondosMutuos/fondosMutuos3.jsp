...
<form action="/solicitud/fondos-mutuos/4" method="post" name="<portlet:namespace/>fm3" id="<portlet:namespace/>fm3" enctype="multipart/form-data">
...
<input type="hidden" id="urlPaso3_fm" value='<portlet:resourceURL id="paso3_fm"/>'/>
