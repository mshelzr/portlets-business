...
<form action="/solicitud/fondos-mutuos/3" method="post" name="<portlet:namespace/>fm2" id="<portlet:namespace/>fm2">
...
<input type="hidden" id="urlPaso2_fm" value='<portlet:resourceURL id="paso2_fm"/>'/>
