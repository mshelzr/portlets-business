...
public class Constantes {
	...
	/** The Constant TOKEN. */
	public static final  String TOKEN="globo-";
	
	/** The mensaje sin resultados. */
	public static String MENSAJE_SIN_RESULTADOS =PortletProps.get("pe.com.interbank.halcon.buscar.descuento.sinresultados");			

	/** The Constant RUTA_LIFERAY. */
	public static final String RUTA_LIFERAY = PropsUtil.get("parametros.img.descuentos.images");
