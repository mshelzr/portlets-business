...
/**
 * Portlet implementation class DetalleEventoController.
 * Clase controladora para la visualizacion de contenido web en la categoria eventos
 *
...
public class DetalleEventoController {
	...
	/** The Constant _log. */
	static final Log _log = LogFactoryUtil.getLog(DetalleEventoController.class);
	//private static Integer indicadorPortlet=19;
