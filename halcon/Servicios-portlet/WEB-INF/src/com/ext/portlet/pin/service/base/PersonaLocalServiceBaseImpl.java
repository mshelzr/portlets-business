...
/**
 * The base implementation of the persona local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.pin.service.impl.PersonaLocalServiceImpl}.
 * </p>
 *
 * @author arodriguez
...
public abstract class PersonaLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ext.portlet.pin.service.PersonaLocalServiceUtil} to access the persona local service.
	 */
	...
	public Persona addPersona(Persona persona) throws SystemException {
		...
		return personaPersistence.update(persona, false);
	}
	 ...
	 */
	public Persona createPersona(long userId) {
		return personaPersistence.create(userId);
	}
	...
	public Persona deletePersona(long userId)
		throws PortalException, SystemException {
		return personaPersistence.remove(userId);
	}
	...
	public Persona fetchPersona(long userId) throws SystemException {
		return personaPersistence.fetchByPrimaryKey(userId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Persona getPersona(long userId)
		throws PortalException, SystemException {
		return personaPersistence.findByPrimaryKey(userId);
	}
	...
	public Persona updatePersona(Persona persona) throws SystemException {
		return updatePersona(persona, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Persona updatePersona(Persona persona, boolean merge)
		throws SystemException {
		persona.setNew(false);

		return personaPersistence.update(persona, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.pin.model.Persona",
			personaLocalService);
	}
