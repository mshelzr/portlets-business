 ...
 * </ul>
 * 
 * The Class ContenidoBeanEdit, bean de un nuevo contenido en modo edit
 *
 * @author Infonet Consulting S.A.C.
 * Fecha:  18/02/2013
 * @version Halcon 1.0
 */
public class ContenidoBeanEdit {
	...
	/**
	 * Establece el id contenido.
	 *
	 * @param idContenido el new id contenido
	 */
